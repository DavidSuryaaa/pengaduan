		...
		if($foto !=""){
		 	if(in_array($eks, $listeks)){
		 		if($size<=100000){
					...
					$query = mysqli_query($koneksi,"INSERT INTO pengaduan VALUES (NULL,'$tgl','$nik','".$kategori."','".$_POST['laporan']."','$nama','proses')");
			...
			$query = mysqli_query($koneksi,"INSERT INTO pengaduan VALUES (NULL,'$tgl','$nik','".$kategori."','".$_POST['laporan']."','noImage.png','proses')");
			if($query){
